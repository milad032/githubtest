...
void DW1000Device::setRange(float range) { _range = range; }//for ancher _range = round(range*100);  for tag _range = range;
...
float DW1000Device::getRange() { return float(_range)/1.0f;}
